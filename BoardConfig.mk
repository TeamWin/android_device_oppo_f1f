...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x80008000 --ramdisk_offset 0x81000000 --tags_offset 0x80000100 --dt device/oppo/f1f/dt.img

# prebuilt kernel
TARGET_PREBUILT_KERNEL := device/oppo/f1f/kernel
# else uncomment below to build from sauce
#TARGET_KERNEL_SOURCE := kernel/oppo/f1f
#TARGET_KERNEL_CONFIG := msm8916_defconfig

BOARD_BOOTIMAGE_PARTITION_SIZE := 25165824
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 26576896
